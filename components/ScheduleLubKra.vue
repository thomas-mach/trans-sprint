<template>
  ...
  <div class="acordions-wrapper">
    ...
    <div class="acordion-wrapper">
      <div class="dot-line-wrapper">
        ...
        <div class="line-point">
          <p
            class="time-leg"
            :class="{ 'display-none': !ui.accordionsState.lublinKra }"
          >
            34 minut
          </p>
        </div>
      ...
      <AcordionItem key-name="lublinKra">
        <template #title>
          <p>Odjazdy Lublin</p>
        </template>
        <template #content>
    ...
    <div class="acordion-wrapper">
      <div class="dot-line-wrapper">
        ...
        <div class="line-point">
          <p
            class="time-leg"
            :class="{ 'display-none': !ui.accordionsState.piaskiKra }"
          >
            12 minut
          </p>
        </div>
      ...
      <AcordionItem key-name="piaskiKra">
        <template #title>
          <p>Odjazdy Piaski</p>
        </template>
        <template #content>
    ...
    <div class="acordion-wrapper">
      <div class="dot-line-wrapper">
        ...
        <div class="line-point">
          <p
            class="time-leg"
            :class="{ 'display-none': !ui.accordionsState.fajslawiceKra }"
          >
            8 minut
          </p>
        </div>
      ...
      <AcordionItem key-name="fajslawiceKra">
        <template #title>
    ...
    <div class="acordion-wrapper">
      <div class="dot-line-wrapper">
        ...
        <div class="line-point">
          <p
            class="time-leg"
            :class="{ 'display-none': !ui.accordionsState.lopiennikKra }"
          >
            12 minut
          </p>
        </div>
      ...
      <AcordionItem key-name="lopiennikKra">
        <template #title>
    ...
    <div class="acordion-wrapper">
      ...
      <AcordionItem key-name="krasnystawKra">
        <template #title>
          <p>Przyjazdy Krasnystaw</p>
        </template>
        <template #content>
          <div class="departure-wrapper">
            <div
...
import departure from "../public/data/departure-lub-kra.json";
